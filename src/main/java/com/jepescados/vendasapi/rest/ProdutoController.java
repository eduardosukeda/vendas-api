...
public class ProdutoController {
	...
	@GetMapping("{id}")
	public ProdutoDto listarPorId(@PathVariable Integer id) {
	...
	@PutMapping("{id}/foto")
	public byte[] adicionarFoto(@PathVariable Integer id, @RequestParam("imagem") Part arquivo) {
		return this.service.adicionarImagem(id, arquivo);
	}
	
	@PutMapping("{id}")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public void atualizar(@PathVariable Integer id, @RequestBody Produto produtoAtualizado, MultipartFile imagemPrincipal, List<MultipartFile> maisImagens) {
